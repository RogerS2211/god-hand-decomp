...
/* func_001A8150 - object constructor: base init, vtable@0x214, loop zeroing a
...
extern int D_00427690;
__attribute__((section(".text.func_001A8150")))
void *func_001A8150(void *a0){
  char *s0; int i;
  func_001BBEB8(a0);
  s0 = (char*)a0 + 0x650;
  *(int**)((char*)a0+0x214) = &D_00427690;
  i = 0;
  do {
    VU0_SQC2_VF0(s0, 0x0);
