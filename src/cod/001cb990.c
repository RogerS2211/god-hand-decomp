/* func_001CB990 — refresh speed-rate field then a +0x2F6 phase machine (record field 0xC,
 * mode 0) stepping func_00157C18.  sn-2.95.3-136. */
...
__attribute__((section(".text.func_001CB990")))
void func_001CB990(void *a0){ char *s0=(char*)a0; int v0;
