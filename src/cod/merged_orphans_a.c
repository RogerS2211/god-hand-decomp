...
/* func_001337A0 — 2-arg variant (no pre-init call). */
extern int D_00460D00, D_0041D5D0;
__attribute__((section(".text.func_001337A0")))
int *func_001337A0(void) {
    if (D_00460D00 == 0) {
...
/* func_00171AB8 — pre-init func_001B8058() + 3-arg registration. */
extern int D_00785868, D_00420D50, D_00785878;
extern void func_001B8058(void);
__attribute__((section(".text.func_00171AB8")))
int *func_00171AB8(void) {
    if (D_00785868 == 0) {
        func_001B8058();
...
/* func_001D0C28 — same shape as func_00171AB8 (shared init + arg2). */
extern int D_00786178, D_0042AB48;
__attribute__((section(".text.func_001D0C28")))
int *func_001D0C28(void) {
    if (D_00786178 == 0) {
        func_001B8058();
...
/* func_00276790 — pre-init func_0028FDD0() + 3-arg registration. */
extern int D_007861C8, D_00447AB8, D_007861D8;
extern void func_0028FDD0(void);
__attribute__((section(".text.func_00276790")))
int *func_00276790(void) {
    if (D_007861C8 == 0) {
        func_0028FDD0();
