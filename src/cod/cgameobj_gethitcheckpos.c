/* cGameObj_getHitCheckPos — virtual dispatch: call the handler at (*(a0+0x214))->0x84 with
...
__attribute__((section(".text.cGameObj_getHitCheckPos")))
void cGameObj_getHitCheckPos(void *a0)
{
    void *new_var3;
