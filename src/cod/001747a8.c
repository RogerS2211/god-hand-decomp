...
/* func_001747A8 - object constructor: base init, set vtable at 0x214, then loop zeroing
...
extern int D_004210D0;
__attribute__((section(".text.func_001747A8")))
void *func_001747A8(void *a0){
  char *s0; int i;
  func_001C7D98(a0);
  s0 = (char*)a0 + 0x660;
