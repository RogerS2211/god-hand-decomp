/* EffEventIsCutDataExist — return whether cut-event data (group 6) is registered
...
__attribute__((section(".text.EffEventIsCutDataExist")))
int EffEventIsCutDataExist(void *a0) {
