...
/* func_00199FD0 - object constructor: base init, set vtable at 0x214, then loop zeroing
...
extern int D_00425290;
__attribute__((section(".text.func_00199FD0")))
void *func_00199FD0(void *a0){
  char *s0; int i;
