...
/* func_00187C88 - object constructor: base init, set vtable at 0x214, then loop zeroing
...
extern int D_00423338;
__attribute__((section(".text.func_00187C88")))
void *func_00187C88(void *a0){
  char *s0; int i;
  InitFields_1B6E90(a0);
  s0 = (char*)a0 + 0x610;
  *(int**)((char*)a0+0x214) = &D_00423338;
  i = 5;
  do {
    VU0_SQC2_VF0(s0, 0x0);
