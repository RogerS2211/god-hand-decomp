...
__attribute__((section(".text.func_00375700")))
void func_00375700(int a0) {
    if (a0 == 0) {
        func_0032BA30(1);
    } else {
        func_0032BA30(0);
...
__attribute__((section(".text.func_003806D8")))
void func_003806D8(char *a0) {
    func_00380E10(a0);
...
__attribute__((section(".text.func_00137AA0")))
void func_00137AA0(char *a0) {
    *(int *)(a0 + 0x0) = 0;
    *(int *)(a0 + 0x30) = 0;
