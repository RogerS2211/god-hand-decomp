...
/* func_0019C320 - object constructor: base init, set vtable at 0x214, then loop zeroing
...
extern int D_00425B90;
__attribute__((section(".text.func_0019C320")))
void *func_0019C320(void *a0){
  char *s0; int i;
  func_001BBEB8(a0);
  s0 = (char*)a0 + 0x650;
  *(int**)((char*)a0+0x214) = &D_00425B90;
  i = 6;
  do {
    VU0_SQC2_VF0(s0, 0x0);
