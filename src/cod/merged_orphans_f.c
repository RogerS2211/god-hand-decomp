...
/* func_00139878: store vtable at obj+0x35C (always); call ForwardFieldNeg20_002A9680_30F5A0
 ...
 * release it via func_001FE278 and clear it; then init via SetField214PtrThenInit_1B6F38. */
