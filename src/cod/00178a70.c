...
/* func_00178A70 - object constructor: base init, set vtable at 0x214, then loop zeroing
...
extern int D_00421658;
__attribute__((section(".text.func_00178A70")))
void *func_00178A70(void *a0){
  char *s0; int i;
  InitVtable214_429C80_1C27E8(a0);
  s0 = (char*)a0 + 0x620;
  *(int**)((char*)a0+0x214) = &D_00421658;
  i = 7;
  do {
    VU0_SQC2_VF0(s0, 0x0);
