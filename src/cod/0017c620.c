...
/* func_0017C620 - object constructor: base init, set vtable at 0x214, then loop zeroing
...
extern int D_00421D68;
__attribute__((section(".text.func_0017C620")))
void *func_0017C620(void *a0){
  char *s0; int i;
  func_001C7D98(a0);
  s0 = (char*)a0 + 0x660;
