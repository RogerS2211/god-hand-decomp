...
/* func_00186738 - object constructor: base init, set vtable at 0x214, then loop zeroing
...
extern int D_00422F90;
__attribute__((section(".text.func_00186738")))
void *func_00186738(void *a0){
  char *s0; int i;
  func_001BBEB8(a0);
  s0 = (char*)a0 + 0x650;
  *(int**)((char*)a0+0x214) = &D_00422F90;
  i = 6;
  do {
    VU0_SQC2_VF0(s0, 0x0);
