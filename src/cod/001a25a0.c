...
/* func_001A25A0 - object constructor: base init, vtable@0x214, loop zeroing a
...
extern int D_00426F88;
__attribute__((section(".text.func_001A25A0")))
void *func_001A25A0(void *a0){
  char *s0; int i;
  InitFields_1B6E90(a0);
  s0 = (char*)a0 + 0x610;
  *(int**)((char*)a0+0x214) = &D_00426F88;
  i = 19;
  do {
    VU0_SQC2_VF0(s0, 0x0);
