...
/* func_001782B8 - object constructor: base init, set vtable at 0x214, then loop zeroing
...
extern int D_004213C0;
__attribute__((section(".text.func_001782B8")))
void *func_001782B8(void *a0){
  char *s0; int i;
  InitVtable214_429C80_1C27E8(a0);
  s0 = (char*)a0 + 0x620;
  *(int**)((char*)a0+0x214) = &D_004213C0;
  i = 5;
  do {
    VU0_SQC2_VF0(s0, 0x0);
