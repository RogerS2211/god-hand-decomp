 ...
 * fields 0xD8/0xDC, mode 0xA) and advances; both phases step func_00157C18 then
...
void func_002884E0(void *a0){ char *s0=(char*)a0; int v0;
 ...
 case 1: func_00157C18(s0); CopyVec3From110To120_14A2B0(s0); Forward30A2B0_2DA9B8(s0); break; } }
