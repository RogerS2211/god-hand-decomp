...
extern int func_00295978(void *a0, float f);
...
extern void func_00273D28(int a0, int a1);

__attribute__((section(".text.func_002960D0")))
void func_002960D0(void *a0, float f) {
    if (func_00295978(a0, f)) {
        int *p = *(int **)((char *)a0 + 4);
...
__attribute__((section(".text.func_00296230")))
void func_00296230(void *a0, int a1, float f) {
    if (func_00295978(a0, f)) {
        int *p = *(int **)((char *)a0 + 4);
        if (func_003A5678(&D_0044A870, p[0x4AC / 4]) == 0) {
            func_00273D28(*(int *)((char *)a0 + 4), a1);
            if (a1 == 0) {
