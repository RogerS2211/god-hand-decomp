...
/* func_0019C588 - object constructor: base init, set vtable at 0x214, then loop zeroing
...
extern int D_00425C78;
__attribute__((section(".text.func_0019C588")))
void *func_0019C588(void *a0){
  char *s0; int i;
  func_001C7D98(a0);
  s0 = (char*)a0 + 0x660;
