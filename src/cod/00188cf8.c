...
/* func_00188CF8 - object constructor: base init, set vtable at 0x214, then loop zeroing
...
extern int D_004234E8;
__attribute__((section(".text.func_00188CF8")))
void *func_00188CF8(void *a0){
  char *s0; int i;
