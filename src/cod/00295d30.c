...
__attribute__((section(".text.func_00295D30")))
void func_00295D30(void *a0, int a1) {
    if (func_00295978(a0)) {
...
__attribute__((section(".text.func_00295EE0")))
void func_00295EE0(void *a0, char a1) {
    if (func_00295978(a0)) {
...
__attribute__((section(".text.func_00296070")))
void func_00296070(void *a0, int a1) {
    void *s0 = a0;
    int s1 = a1;
    if (func_00295978(s0)) {
...
__attribute__((section(".text.func_002962B0")))
void func_002962B0(void *a0) {
