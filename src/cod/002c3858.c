...
extern void func_002C4DE0(void *a0);
extern void func_002C3820(void *a0);
extern void func_002D56A8(void *a0);
extern void func_002D5AA0(int a0, int a1);
...
extern void func_002C4390(char *a0);
...
void func_002C3E88(void *a0) {
    ...
    while (func_002C3E40(s0) == 0) {
        func_002D5AA0(*(int *)(s1 + 4), 1);
    }
}

__attribute__((section(".text.func_002C3ED8")))
int func_002C3ED8(void *a0, int a1) {
    return func_002C3F10(a0, func_0031CE38(a1));
}

__attribute__((section(".text.func_002C3F10")))
int func_002C3F10(void *a0, int a1) {
    char *s0;
    if (a1 == 0) {
        return 0;
    }
...
void func_002C3FC0(void *a0) {
    ...
    func_00138D40(s0, 0);
    func_00124F60(func_002DB6B0(), 0, 1);
...
void func_002C4078(void *a0) {
    while (func_002C4040(a0) == 0) {
        func_002D5AA0(*(int *)((char *)PTR_DAT_003c2f84 + 0x20), 1);
    }
}

__attribute__((section(".text.func_002C40C8")))
int func_002C40C8(void *a0, unsigned short a1, int a2, int a3, unsigned char t0, int t1) {
    int v0;
    if (a2 != 0) {
        v0 = func_0031CE38(a2);
    } else {
...
__attribute__((section(".text.func_002C42E0")))
void func_002C42E0(char *a0, int a1) {
...
__attribute__((section(".text.func_002C4390")))
void func_002C4390(char *a0) {
    if (*(unsigned short*)(a0 + 0x112) != 0xFFFF) {
...
__attribute__((section(".text.func_002C4440")))
void func_002C4440(int a0, char *a1, float p0, float p1, float p2, float p3) {
